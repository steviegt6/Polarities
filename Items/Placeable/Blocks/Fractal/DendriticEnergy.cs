...
namespace Polarities.Items.Placeable.Blocks.Fractal
{
    ...
    public class DendriticEnergyTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            DustType = 84;
            ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<DendriticEnergy>();
